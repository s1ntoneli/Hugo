...
import com.antiless.hugo.R;
import com.antiless.hugo.log.LogInfo;

public class LogFloatWindowService extends FloatWindowHostService {
    private LayoutInflater mInflater = null;
    public static final String ACTION_APPEND_LOG = "com.com.antiless.hugo.append_log";
    public static final String EXTRA_TAG = "tag";
    public static final String EXTRA_MESSAGE = "message";
    public static final String EXTRA_LEVEL = "level";

    public static final String ACTION_CLEAR_LOG = "com.com.antiless.hugo.clear_log";
    public static final String ACTION_SHOW_WINDOW = "com.com.antiless.hugo.show_window";
    public static final String ACTION_HIDE_WINDOW = "com.com.antiless.hugo.hide_window";
